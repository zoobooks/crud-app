...
This is a Maven project. It is a simple CRUD web application known to work with Java 8 and Tomcat 8. It uses Spring MVC with JSP views and Spring JDBC with an embedded database. The established features allow the user to manage a list of people with contact information.
